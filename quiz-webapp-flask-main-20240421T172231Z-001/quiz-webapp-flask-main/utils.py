...
class Score:
    ...
    def __init__(self, name, email, score, personality,job_profile,job_profile2,job_profile3):
        self.name = name
        self.email = email
        self.score = score
...
def create_score_object(listElement):
    return Score(
        get_field(listElement, 0), get_field(listElement, 1), get_field(listElement, 3),get_field(listElement, 6),get_field(listElement, 7),get_field(listElement, 8),get_field(listElement, 9)
    )
